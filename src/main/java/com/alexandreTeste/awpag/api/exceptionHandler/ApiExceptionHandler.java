package com.alexandreTeste.awpag.api.exceptionHandler;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers,
        ...
        problemDetail.setTitle("um ou mais camnpos estao invalidos");
        problemDetail.setType(URI.create("https://alexandreTeste.com/erros/camposInvalidos"));
    ...
    public ProblemDetail handleNegocio (NegocioException e){
        ...
        problemDetail.setType(URI.create("https://alexandreTeste.com/erros/erro_de_regra_de_negocio"));
    ...
    public ProblemDetail handleDataIntegrityViolation (DataIntegrityViolationException dataIntegrityViolationException){
        ...
        problemDetail.setType(URI.create("https://alexandreTeste.com/erros/recurso_em_uso"));
